...
```txt
Last update: Mon Jan 15 2024 21:31:32 GMT+0000 (Coordinated Universal Time)
Number of proxy: 21
Number of https proxy: 9
Number of http proxy: 12
Number of proxy by Anonymity: Unknown -> 0, Low -> 7, Average -> 1, High -> 13
Average speed: 338 ms
Countries (6): IN, US, DE, VE, MX, BR
Success (4):
